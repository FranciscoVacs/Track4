      ...
      <div className="grid grid-cols-12 gap-6 w-full items-center relative z-10">
        ...
        <div className="col-span-5">
          <div className="flex items-baseline justify-between mb-1.5">
            <span className="uppercase-label text-[12px]">Aprendizaje del modelo</span>
            <span className="text-[11px] text-[var(--muted-foreground)]">v2.4 · hace 14 días</span>
          </div>
        ...
        <div className="col-span-4 flex flex-col">
          <span className="uppercase-label text-[11px] mb-1.5">Precisión (7 ciclos)</span>
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] text-emerald-600 font-semibold">+4.3% vs v1.0</span>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-3 flex flex-col">
          <span className="uppercase-label text-[11px] mb-1.5">Decisiones recientes</span>
